...
-- CREATE INDEX "parent" -----------------------------------
-- CREATE INDEX "parent" ---------------------------------------
CREATE INDEX `parent` USING BTREE ON `menu`( `parent` );
-- -------------------------------------------------------------
-- ---------------------------------------------------------
...
-- CREATE INDEX "idx-auth_item-type" ---------------------------
CREATE INDEX `idx-auth_item-type` USING BTREE ON `auth_item`( `type` );
-- -------------------------------------------------------------
-- ---------------------------------------------------------
...
-- CREATE INDEX "rule_name" ------------------------------------
CREATE INDEX `rule_name` USING BTREE ON `auth_item`( `rule_name` );
-- -------------------------------------------------------------
-- ---------------------------------------------------------
...
-- CREATE INDEX "child" ------------------------------------
-- CREATE INDEX "child" ----------------------------------------
CREATE INDEX `child` USING BTREE ON `auth_item_child`( `child` );
-- -------------------------------------------------------------
-- ---------------------------------------------------------


-- CREATE LINK "menu_ibfk_1" -------------------------------
-- DROP LINK "menu_ibfk_1" -------------------------------------
...
-- CREATE LINK "auth_assignment_ibfk_1" --------------------
-- DROP LINK "auth_assignment_ibfk_1" --------------------------
...
-- CREATE LINK "auth_item_ibfk_1" --------------------------
-- DROP LINK "auth_item_ibfk_1" --------------------------------
...
-- CREATE LINK "auth_item_child_ibfk_1" --------------------
-- DROP LINK "auth_item_child_ibfk_1" --------------------------
...
-- CREATE LINK "auth_item_child_ibfk_2" --------------------
-- DROP LINK "auth_item_child_ibfk_2" --------------------------
